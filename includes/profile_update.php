...
<body class="hold-transition sidebar-mini">
 ...
 ?>
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE `users` SET user_name='{$user_name}',user_email='{$user_email}', user_blood ='{$user_blood}',user_address='{$user_address}',user_phone='{$user_phone}' WHERE user_id='$user_id_s'";
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <h3 class="card-title"><?php echo "$msg" ; ?></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
